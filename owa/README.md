...
# openmrs-module-locationbased

This repository contains the openmrs-module-locationbased OpenMRS Open Web App.
...
This will create a file called `openmrs-module-locationbased.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/home/tawrun/openmrs/openmrs-platform/owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "/home/tawrun/openmrs/openmrs-platform/owa"
}
```
...
{
  "LOCAL_OWA_FOLDER": "/home/tawrun/openmrs/openmrs-platform/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/openmrs-module-locationbased/index.html"
}
```
